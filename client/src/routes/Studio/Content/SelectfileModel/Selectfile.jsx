...
const Selectfile = ({togglemodal,setVideoFile,videoFile,setvideoUrl  }) => {
...
const urlRef = useRef()
  ...
  return (
    ...
    <p className='upload-vid-heading' >Upload videos</p>
    ...
    <button  className=' url-input-next   ' onClick={(e)=>{setvideoUrl(urlRef.current.value)    }  }   > Next  </button> </>  :  <>  <label   className='btn btn-light select-files-light-btn'>  {videoFile ?  videoFile.name : 'select file' }
    <input 
    accept="video/*" 
    name="video" 
    type="file"
