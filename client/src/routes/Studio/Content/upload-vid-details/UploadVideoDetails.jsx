...
const UploadVideoDetails = ({videoUrl,videoFile,setvideoUrl,setVideoFile}) => {
...
const res = await fetch (`https://youtube-clone-v8xu.onrender.com/api/videos/uploadVideo/${logiData?.user?._id}` , {
method:"POST",
body:videoData
})
